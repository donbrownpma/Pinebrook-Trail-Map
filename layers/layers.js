...
var format_webTrails_5 = new ol.format.GeoJSON();
var features_webTrails_5 = format_webTrails_5.readFeatures(json_webTrails_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_webTrails_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_webTrails_5.addFeatures(features_webTrails_5);
var lyr_webTrails_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_webTrails_5, 
                style: style_webTrails_5,
                popuplayertitle: 'webTrails',
                interactive: true,
                title: 'webTrails'
            });
var format_trailheadparking_6 = new ol.format.GeoJSON();
var features_trailheadparking_6 = format_trailheadparking_6.readFeatures(json_trailheadparking_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_trailheadparking_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_trailheadparking_6.addFeatures(features_trailheadparking_6);
var lyr_trailheadparking_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_trailheadparking_6, 
                style: style_trailheadparking_6,
                popuplayertitle: 'trailhead parking',
                interactive: true,
                title: '<img src="styles/legend/trailheadparking_6.png" /> trailhead parking'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_openspace_1.setVisible(true);lyr_Roads_2.setVisible(true);lyr_pinebrookextent_3.setVisible(true);lyr_Parcels_4.setVisible(true);lyr_webTrails_5.setVisible(true);lyr_trailheadparking_6.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_openspace_1,lyr_Roads_2,lyr_pinebrookextent_3,lyr_Parcels_4,lyr_webTrails_5,lyr_trailheadparking_6];
...
lyr_webTrails_5.set('fieldAliases', {'Name': 'Name', 'Surface': 'Surface', 'Difficulty': 'Difficulty', 'Status': 'Status', 'Descriptn': 'Descriptn', 'Length': 'Length', });
lyr_trailheadparking_6.set('fieldAliases', {'id': 'id', 'name': 'name', 'summercap': 'summercap', 'wintercap': 'wintercap', 'hndicap': 'hndicap', });
...
lyr_webTrails_5.set('fieldImages', {'Name': 'TextEdit', 'Surface': 'TextEdit', 'Difficulty': 'TextEdit', 'Status': 'TextEdit', 'Descriptn': 'TextEdit', 'Length': 'TextEdit', });
lyr_trailheadparking_6.set('fieldImages', {'id': 'TextEdit', 'name': 'TextEdit', 'summercap': 'Range', 'wintercap': 'Range', 'hndicap': 'Range', });
...
lyr_webTrails_5.set('fieldLabels', {'Name': 'inline label - visible with data', 'Surface': 'inline label - visible with data', 'Difficulty': 'inline label - visible with data', 'Status': 'inline label - visible with data', 'Descriptn': 'inline label - visible with data', 'Length': 'inline label - visible with data', });
lyr_trailheadparking_6.set('fieldLabels', {'id': 'inline label - visible with data', 'name': 'inline label - visible with data', 'summercap': 'inline label - visible with data', 'wintercap': 'inline label - visible with data', 'hndicap': 'inline label - visible with data', });
lyr_trailheadparking_6.on('precompose', function(evt) {
